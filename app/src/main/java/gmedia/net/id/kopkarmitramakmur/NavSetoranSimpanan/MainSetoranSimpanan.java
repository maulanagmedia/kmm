package gmedia.net.id.kopkarmitramakmur.NavSetoranSimpanan;
...
public class MainSetoranSimpanan extends Fragment {
    ...
    private String TAG = "Setoran";
    private String noTabungan = "", jumlahSetoran;
    private List<JenisTabunganModel> jenisTabunganModels;
    private String selectedJenisTabungan = "", selectedJenisTabunganString = "";
    public static int UPLOAD_REQUEST_CODE = 11;
    public static int LOAD_REQUEST_CODE = 12;
    ...
    public MainSetoranSimpanan() {
        // Required empty public constructor
    }

    public static MainSetoranSimpanan newInstance(String param1, String param2) {
        MainSetoranSimpanan fragment = new MainSetoranSimpanan();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        layout = inflater.inflate(R.layout.fragment_main_setoran_simpanan, container, false);
        initUI();
    ...
    private void initUI() {
        ...
        llDaftar = (LinearLayout) layout.findViewById(R.id.ll_daftar_setoran);
        llSimpan = (LinearLayout) layout.findViewById(R.id.ll_simpan_setoran);
    ...
    private void tampilNoTabunganChosen(final List<String> listItem) {
        ...
        final int[] lastSeleted = {noTabunganSelected}; // select at 0
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                noTabunganSelected = lastSeleted[0];
                tvNoTabungan.setText(listItem.get(noTabunganSelected).toString());
            }
        });
    ...
    private void initEvent(){
        ...
        llDaftar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("jenis", Utils.Setoran);
        ...
        llSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            if(tvNoTabungan.getText().length() > 0 && tvJenisTabungan.getText().length() > 0/*Converter.convertJenisTabungan(tvJenisTabungan.getText().toString()) != Converter.convertJenisTabungan("Simpanan Sukarela")*/){
                ...
                jumlahSetoran = edtJumlah.getText().toString().replace(",", "");
                jumlahSetoran = jumlahSetoran.replace(".", "");
                if(iv.parseNullInteger(jumlahSetoran) <= 0){

                    edtJumlah.setError("Jumlah Setoran harus lebih dari dari 0");
                    return;
                }
    ...
    private void simpanSetoran(){
        ...
        try {
            ...
            jBody.put("nik", session.getNik());
            jBody.put("jumlah", jumlahSetoran);
        ...
        ApiVolley request = new ApiVolley(getContext(), jBody, "POST", WebServiceURL.insertSetoran, "", "", 0, new ApiVolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if(iv.parseNullInteger(status) == 200){
                        ...
                        Toast.makeText(getContext(), "Data Setoran berhasil disimpan", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(getContext(), DetailPengajuan.class);
                        intent.putExtra("jenis", Utils.Setoran);
