package gmedia.net.id.kopkarmitramakmur.NotificationUtil;
...
import gmedia.net.id.kopkarmitramakmur.NavNews.DetailNewsWeb;
    ...
    private void sendNotification(String title, String body , HashMap<String, String> extra) {
        ...
        for(String key: extra.keySet()){
            if(key.trim().toUpperCase().equals("JENIS")){
                if(extra.get(key).trim().toUpperCase().equals("NEWS")){
                    newsFlag = 1;
                }else if(extra.get(key).trim().toUpperCase().equals(Utils.Belanja)){
                    newsFlag = 2;
                }
            }
        }
        ...
        switch (newsFlag){
            case 1:
                intent = new Intent(this, DetailNewsWeb.class);
                break;
            case 2:
                intent = new Intent(this, DetailRiwayatBelanja.class);
                break;
            case 3:
                intent = new Intent(this, DetailPengajuan.class);
                break;
            default:
                intent = new Intent(this, DetailPengajuan.class);
                break;
